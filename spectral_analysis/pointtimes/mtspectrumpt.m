function [S, f, R, Serr] = mtspectrumpt(data, params, fscorr, t)
    ...
    %                              and p is an integer such that 2TW-p
    %                              tapers are used. In this form there is no
    %                              default i.e. to specify the bandwidth,
    %                              you have to specify T and p as well. Note
    %                              that the units of W and T have to be
    %                              consistent: if W is in Hz, T must be in
    %                              seconds and vice versa. Note that these
    %                              units must also be consistent with the
    ...
    %                          all frequencies between 0 and Fs/2
